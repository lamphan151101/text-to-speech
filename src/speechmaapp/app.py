...
from speechmaapp.utils.subprocess_utils import ensure_no_cmd_window

# Patch subprocess before any library spawns child processes.
ensure_no_cmd_window()

from PySide6.QtGui import QIcon  # noqa: E402
from PySide6.QtWidgets import QApplication  # noqa: E402

from speechmaapp.config import AppConfig  # noqa: E402
from speechmaapp.ui.main_window import MainWindow  # noqa: E402
from speechmaapp.utils.i18n import translator  # noqa: E402
from speechmaapp.utils.logging_utils import init_logging, log_info  # noqa: E402
...
def main() -> int:
    ...
    log_info(f"SpeechMa started, logs dir={logs_dir}")
    ...
    if icon_path is not None:
        ...
        if sys.platform.startswith("win"):
            try:
                import ctypes
                ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("SpeechMa.App")
            except Exception:
                pass
